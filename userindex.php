    ...
    <body>
        ...
        <div class="container-fluid bg-white text-center mb-0 p-2">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card" data-aos="flip-left">
                        <img src="assets/img/athletic.png" class="card-img-top" alt="Athletics">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card" data-aos="flip-left">
                        <img src="assets/img/swimming.png" class="card-img-top" alt="Swimming">
                        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card" data-aos="flip-left">
                        <img src="assets/img/basketball.png" class="card-img-top" alt="Basketball">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card" data-aos="flip-left">
                        <img src="assets/img/football.png" class="card-img-top" alt="Football (Soccer)">
                        <div class="card-body">
